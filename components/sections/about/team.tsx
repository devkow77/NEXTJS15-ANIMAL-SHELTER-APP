    ...
    <section id="team">
      <Container className="space-y-6 lg:space-y-12">
        ...
        <div className="space-y-6">
          <h3 className="text-lg font-black md:text-xl">Owners</h3>
          <section className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 lg:gap-8">
            {owners.map(
              (
                ...
                <div key={index} className="space-y-4">
                  <div className="relative aspect-square w-full rounded-full bg-neutral-800">
                    <Image
                      src={url}
                      alt={name}
                      fill
        ...
        <div className="space-y-6">
          <h3 className="text-lg font-black md:text-xl">Staff</h3>
          <section className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 lg:gap-8">
            {staff.map(
              (
                { name, specialization, profile: { url } }: Worker,
        ...
        <div className="space-y-2">
          <h3 className="text-lg font-black md:text-xl">And You Volunteers</h3>
